...
const ResponsiveImage = (props: any) => {
    ...
    const imgSrc = !props.src.startsWith(docsImportPath) ? props.src : props.src.slice(docsImportPath.length);
...
const UL = (props: any) => <UnorderedList my={4}>{props.children}</UnorderedList>;
