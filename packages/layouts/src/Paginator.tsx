...
import {Flex, Button, ButtonGroup, Select, Spacer, chakra, ScaleFade} from "@chakra-ui/react";
import {useAppRouter} from "@peersky/react-hooks";

const _Paginator = ({children, setLimit, setPage, paginatorKey, hasMore, pageOptions, page, pageSize, ...props}) => {
        ...
        <Flex justifyContent={"space-between"} py={4} pt={2}>
            ...
            >
                ...
                <Select
                    ...
                    onChange={(e) => {
                        router.appendQuery(`${paginatorKey}Limit`, e.target.value, false, false);
                    }}
