import {Stack, Heading, chakra, Box, Link as ChakraLink, Flex, As} from "@chakra-ui/react";
    ...
    return (
        <Link href={link} shallow scroll>
            ...
            >
                ...
                <Heading size={heading.length > 32 ? "sm" : "md"} textAlign="center" as={level ?? "h2"} _hover={{}}>
                    {heading}
                </Heading>
                <chakra.span textAlign={"center"} textColor={textColor ?? "blue.400"} px={2}>
                    {text}
                </chakra.span>
            </Stack>
        </Link>
