...
const _Metadata = ({metadata, ...props}: {noPreviewChars?: number; metadata: any}) => {
    ...
    return (
        ...
        >
            <Box
                ...
                bgImage={"https://peersky.infura-ipfs.io/ipfs/Qmam3ryLCZCTaAN7qTQrNiXwgbiBFyQypXkWcrjPnsCPHQ"}
