...
import {SiteMapItem, SiteMapItemType} from "@peersky/react-types";
...
const _Navbar = ({
    ...
    const {isMobileView, webSiteConfig, setSidebarToggled, sidebarToggled} = useContext(UIContext);
        ...
        >
            ...
            <Flex pr={14} justifyItems="flex-end" flexGrow={1} alignItems="center">
                ...
                <ButtonGroup variant="solid" spacing={4} pr={16}>
                    {sitemap
                        ?.filter((item: SiteMapItem) => item.type != SiteMapItemType.FOOTER_CATEGORY)
