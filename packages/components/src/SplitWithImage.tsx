                    ...
                    {bullets.map((bullet, idx) => {
                        return (
                            <Feature
                                ...
                                // text={bullet.text}
                                {...bullet}
                                icon={<Icon as={bullet.icon} color={bullet.color} w={16} h={16} />}
                            />
                        );
                    })}
                </Stack>
...
const _SplitWithImage = ({
    ...
    const [theme100, theme200, theme300, theme900] = useToken(
        ...
        [`${colorScheme}.100`, `${colorScheme}.200`, `${colorScheme}.300`, `${colorScheme}.900`]
            ...
            <SimpleGrid columns={{base: 1, md: 2}} spacing={[0, 0, 10, null, 10]}>
                ...
                <Stack spacing={[2, 4]} justifyContent="center">
                    ...
                    >
                        {bullets?.map((bullet, idx) => {
                            return (
                                <Feature
                                    ...
                                    icon={bullet.icon && <Icon as={bullet.icon} color={bullet.color} w={16} h={16} />}
                                    iconBg={bullet.bgColor}
                                    text={bullet.text}
                        ...
                        <Flex w="100%" flexWrap="nowrap" display={["column", "column", null, "row"]}>
                            {socialButton && (
                                <RouteButton
                                    isExternal
