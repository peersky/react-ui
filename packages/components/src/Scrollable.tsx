...
const _Scrollable = ({className, children, ...props}: {children: any; className: string}) => {
    ...
    const getScrollPrecent = ({currentTarget}: {currentTarget: any}) => {
        const scroll_level =
            (100 * (currentTarget.scrollTop + currentTarget.clientHeight)) / currentTarget.scrollHeight;
        return scroll_level;
    };
