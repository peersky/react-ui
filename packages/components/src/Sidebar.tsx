...
import {IconButton, Divider, useColorMode, useColorModeValue, useTheme, Box} from "@chakra-ui/react";
...
export const _Sidebar = ({
    ...
    return (
        <Sidebar width="280px" backgroundColor={"#006D99"} breakPoint="lg" hidden={!ui.sidebarVisible}>
            <Menu>
