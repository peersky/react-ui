...
export const Footer = ({colorScheme, initialLogo, ...props}: {colorScheme?: string; initialLogo?: string}) => {
            ...
            <Container as={Stack} maxW={"8xl"} py={10}>
                <SimpleGrid templateColumns={{sm: "1fr 1fr", md: "2fr 1fr 1fr 1fr 1fr"}} spacing={8}>
                    <Stack spacing={6}>
                        ...
                        <Text fontSize={"sm"}>
                            © {moment().year()} {ui.webSiteConfig.COPYRIGHT_NAME} All rights reserved
                        </Text>
                    ...
                    {ui.webSiteConfig.SITEMAP.length > 0 &&
                        Object.values(ui.webSiteConfig.SITEMAP).map((category, colIndex) => {
                            return (
